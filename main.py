...
def get_info():
    intro_text = ["Об игре",
                  "Bunny-game – это игра, в которой нужно проходить уровни",
                  "передвигаясь за зайчика, впереди могут встретиться различные",
                  "опасности, нужно всегда быть на чеку.", '',
                  'Как играть',
                  'Зайчик непрерывно бежит и отталкивается от стен, при нажатии',
                  'на клавишу space зайчик подпрыгивает, он может подпрыгнуть',
                  'даже находясь в воздухе, максимально может подпрыгнуть 2 раза',
                  'до приземления. При нажатии на клавишу escape игра ставится',
                  'на паузу и появляется меню для выбора дальнейших действий.',
                  'В игре присутствуют враги и шипы при соприкосновении',
                  'с которыми вы проиграете и придется начать заново.', '', '',
